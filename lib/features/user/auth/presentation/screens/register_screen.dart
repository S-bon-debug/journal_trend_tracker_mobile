...
import 'auth_desktop_panel.dart';
          ...
          if (isDesktop) ...[
            Align(
              ...
              child: TextButton.icon(
                ...
                label: Text('Back', style: TextStyle(color: textColor, fontSize: 14)),
          ...
          child: isDesktop
              ? Row(
                  children: [
                    const Expanded(
                      flex: 5,
                      child: AuthDesktopPanel(),
                    ),
                    Expanded(
                      flex: 4,
                      child: Container(
                        color: isDark ? const Color(0xFF0F0F14) : Colors.white.withOpacity(0.4),
                        child: Center(
