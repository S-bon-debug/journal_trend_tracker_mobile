...
class _BookmarksScreenState extends State<BookmarksScreen> {
  ...
  void _unfollowKeyword(int index) {
  ...
  void _unfollowJournal(int index) {
      ...
      child: Column(
        ...
        children: [
          ...
          if (_followedKeywords.isEmpty)
            Text('Not following any keywords.', style: GoogleFonts.inter(color: Colors.white30, fontSize: 14))
          else
            Wrap(
              spacing: 8.0,
              runSpacing: 8.0,
          ...
          if (_followedJournals.isEmpty)
            Text('Not following any journals.', style: GoogleFonts.inter(color: Colors.white30, fontSize: 14))
          else
            ListView.separated(
              shrinkWrap: true,
