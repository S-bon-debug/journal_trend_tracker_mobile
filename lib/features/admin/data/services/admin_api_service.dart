  ...
  List<SystemSettingDto> _getMockSettings() {
    _cachedMockSettings ??= [
      ...
      SystemSettingDto(
        ...
        value: '0 2 * * *',
        description: 'Cron schedule for daily trend snapshot computation',
        updatedBy: '11111111-1111-1111-1111-111111111111',
        updatedAt: DateTime.now().subtract(const Duration(days: 15)).toIso8601String(),
      ),
      SystemSettingDto(
        ...
        description: 'Sender email address for scientific journal trend notifications',
        updatedBy: '11111111-1111-1111-1111-111111111111',
        updatedAt: DateTime.now().subtract(const Duration(days: 15)).toIso8601String(),
      ),
      SystemSettingDto(
        ...
        description: 'Default fields of study for data synchronization',
        updatedBy: '11111111-1111-1111-1111-111111111111',
        updatedAt: DateTime.now().subtract(const Duration(days: 15)).toIso8601String(),
      ),
    ];
